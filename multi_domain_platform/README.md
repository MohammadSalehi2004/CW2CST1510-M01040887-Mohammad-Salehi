# Student information
Student Name: Mohammad Salehi
Student Misis: M01040887
Information Technology
Course: CST1510 -CW2 - Multi-Domain Intelligence Platform

## Project Description
This is a README file and an instruction on how to run the CW2 files from week 8 to 10
## Instructions
- First make sure all the files are corectly located as my github, which is the same structure given in week 8
...
## Important to note that the week11 streamlit files dont function since there is no database backend. but the use of OOP is completed for the files. However the lab for week11 is unclear about the directions.